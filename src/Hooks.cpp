		...
		namespace Default
		{
			...
			struct GetDisplayFullName_GetDisplayName
			{
				...
				static void pre_hook() {
					...
					REL::safe_fill(relocation.address() + REL::VariantOffset{ 0x240, 0x236 }.offset(), 0x4C, 1);
					REL::safe_fill(relocation.address() + REL::VariantOffset{ 0x241, 0x237 }.offset(), 0x89, 1);
					REL::safe_fill(relocation.address() + REL::VariantOffset{ 0x242, 0x238 }.offset(), 0xFA, 1);
					REL::safe_fill(relocation.address() + REL::VariantOffset{ 0x243, 0x239 }.offset(), 0x90, 1);
				}
			...
			struct GetDisplayFullName_GetFormName
			{
				...
				static void pre_hook() {
					...
					REL::safe_fill(relocation.address() + REL::VariantOffset{ 0x232, 0x228 }.offset(), 0x4C, 1);
					REL::safe_fill(relocation.address() + REL::VariantOffset{ 0x233, 0x229 }.offset(), 0x89, 1);
					REL::safe_fill(relocation.address() + REL::VariantOffset{ 0x234, 0x22A }.offset(), 0xF9, 1);
					REL::safe_fill(relocation.address() + REL::VariantOffset{ 0x235, 0x22B }.offset(), 0x90, 1);
				}
			...
			namespace PickpocketNotification
			{
				...
				struct Activate_GetBaseObject
				{
					...
					static void pre_hook() {
						...
						REL::safe_fill(relocation.address() + REL::VariantOffset{ 0x6B0, 0x6CF }.offset(), 0x90, 13);
					}
		...
		namespace Barter
		{
			...
			struct BarterMenu_GetShortName
			{
				...
				static void pre_hook() {
					...
					REL::safe_fill(relocation.address() + REL::VariantOffset{ 0x20A, 0x20A }.offset(), 0x4D, 1);
					REL::safe_fill(relocation.address() + REL::VariantOffset{ 0x20B, 0x20B }.offset(), 0x30, 1);
				}
